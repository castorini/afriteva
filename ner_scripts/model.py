...
from ner_datasets import get_dataset
...
class T5FineTuner(pl.LightningModule):
    ...
    def val_dataloader(self):
        val_dataset = get_dataset(
            tokenizer=self.tokenizer, type_path="dev", args=self.hparam
        )
        return DataLoader(
            val_dataset, batch_size=self.hparam.eval_batch_size, num_workers=4
        )
