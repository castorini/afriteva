...
def calc_num_samples_sentences(
    ...
    """
    Calculate the number of sentences to sample from each language
    using the multinomial distribution formula in:
    https://arxiv.org/pdf/1901.07291.pdf
    Upsampling low resource languages and upsampling high resource languages
    """
    lang_prob = {}
